...
public class UserListAdapter3 extends BaseAdapter {
    ...
    private List<Board> saveList2;


    //여기서 Actvitivy parentActivity가 추가됨 회원삭제 및 관리자기능 예제

    public UserListAdapter3(Context context2, List<Board> userList2, Activity parentActivity, List<Board> saveList2){
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        View v = View.inflate(context2, R.layout.boradlist_tool, null);
        ...
        deleteButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                DeleteRequest3 deleteRequest = new DeleteRequest3(id.getText().toString(), responseListener);
