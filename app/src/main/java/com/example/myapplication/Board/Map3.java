...
public class Map3 extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.logout:
                Intent intent = new Intent( Map3.this, LoginActivity.class);

                startActivity( intent );
                break;
            case R.id.home:
                Intent intent2 = new Intent( Map3.this, BolistAct.class);
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        mGoogleMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng point) {
                ...
                //if(mOptions != null) mOptions.remove();
                // 마커 타이틀
                mOptions.title("클릭한 위치의 좌표");
               // mOptions.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_AZURE));
                ...
                // 마커(핀) 추가
                marker2 = googleMap.addMarker(mOptions);
                ...
                save.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent( Map3.this, BoMA.class);
