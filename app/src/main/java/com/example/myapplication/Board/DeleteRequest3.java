 ...
 */
public class DeleteRequest3 extends StringRequest {
    //현재 안드로이드앱을 에뮬레이터로 돌리므로 에뮬레이터가 설치된 서버에 있는 아파치 서버에 접근하려면
    //다음과 같이 10.0.2.2:포트번호 로 접근해야합니다 저는 8080 포트를 써서 다음과 같이 했습니다
    final static private String URL = "http://203.234.62.111/a/Delete2.php";
    private Map<String, String> parameters;

    public DeleteRequest3(String id, Response.Listener<String> listener){
