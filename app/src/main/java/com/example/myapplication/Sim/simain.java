            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < a.size(); i++) {
                    if (input.get(0).getName().contains(a.get(i).getName())) {
                        ...
                        }else if(re.get(0).getMeasure()< outcome){
                            re.remove(0);
                            result.remove(0);
                            simst sim = new simst();
                            sim.setName(a.get(i).getName());
